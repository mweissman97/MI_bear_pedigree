...
```{r}
packages <- c("ggplot2", "CKMRsim", "sequoia", "readxl", "viridis", "vcfR", "adegenet", "hierfstat", "pegas", "tidyverse", "smartsnp", "factoextra") 
...
# Run the function with our list of packages
